...
export default function MyPageLogin() {
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView style={{ flex: 1 }} contentContainerStyle={{ paddingBottom: 80 }}>
        ...
        <View style={styles.sectionWrapper}>
          ...
          <View style={styles.card}>
            ...
            <TouchableOpacity style={[styles.cardRow, { borderBottomWidth: 0 }]}> 
          ...
          <View style={styles.card}>
            ...
            <TouchableOpacity style={styles.cardRow}>
              ...
              <View style={styles.cardTextWrapper}>
                ...
                <Text style={styles.cardDesc}>서비스 이용약관 및 개인정보처리방침</Text>
              </View>
              <Feather name="chevron-right" size={20} color="#bbb" />
            </TouchableOpacity>
      ...
      />
      <SignupModal visible={signupModalVisible} onClose={() => setSignupModalVisible(false)} onSignup={handleSignupSuccess} />
    </View>
  );
}
...
const styles = StyleSheet.create({
  ...
  header: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: 16, paddingVertical: 12, backgroundColor: '#ef4444' },
  logo: { color: 'white', fontSize: 20, fontWeight: 'bold' },
  profileSection: { alignItems: 'center', paddingVertical: 32, backgroundColor: 'white', borderBottomWidth: 1, borderBottomColor: '#e5e7eb' },
  profileIconWrapper: { width: 80, height: 80, borderRadius: 40, backgroundColor: '#e5e7eb', alignItems: 'center', justifyContent: 'center', marginBottom: 16 },
  loginPrompt: { fontSize: 18, fontWeight: '600', marginBottom: 16 },
  loginButtonRow: { flexDirection: 'row', gap: 12 },
  loginButton: { backgroundColor: '#ef4444', paddingHorizontal: 24, paddingVertical: 8, borderRadius: 9999, marginRight: 12 },
  loginButtonText: { color: 'white', fontWeight: '600' },
  signupButton: { borderWidth: 1, borderColor: '#ef4444', paddingHorizontal: 24, paddingVertical: 8, borderRadius: 9999 },
  ...
  profileEditBtn: { borderWidth: 1, borderColor: '#e11d48', borderRadius: 9999, paddingHorizontal: 16, paddingVertical: 5, marginBottom: 4 },
  ...
  cardRow: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: 16, paddingVertical: 16, borderBottomWidth: 1, borderBottomColor: '#f3f4f6' },
  ...
  logoutBtn: { borderWidth: 1, borderColor: '#e11d48', borderRadius: 8, paddingVertical: 13, alignItems: 'center', marginHorizontal: 16, marginTop: 8, marginBottom: 24 },
  logoutBtnText: { color: '#e11d48', fontWeight: 'bold', fontSize: 16 },
  tabBar: { flexDirection: 'row', justifyContent: 'space-around', alignItems: 'center', height: 56, borderTopWidth: 1, borderTopColor: '#e5e7eb', backgroundColor: 'white', position: 'absolute', bottom: 0, left: 0, right: 0 },
